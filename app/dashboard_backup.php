        ...
        <form id="form-hallazgo" method="post" enctype="multipart/form-data" novalidate>
          ...
          <div class="form-section">
            <label for="job_order" class="form-label">📋 <span data-translate="jobOrder">Job Order</span></label>
              <input type="text" class="form-control" name="job_order" id="job_order" maxlength="100" autocomplete="off" data-translate-placeholder="optional">
              <div class="form-text" data-translate="optional">Opcional</div>
          </div>
          ...
          <!-- Cantidad de Piezas -->
          <div class="form-section">
            <label for="cantidad_piezas" class="form-label">📦 <span data-translate="pieceQuantity">Cantidad de Piezas</span></label>
            <input type="number" class="form-control" name="cantidad_piezas" id="cantidad_piezas" 
                   value="1" min="1" max="999999" required 
                   autocomplete="off" data-translate-placeholder="quantity">
            <div class="form-text" data-translate="quantityHelp">Por defecto: 1 pieza. Mínimo: 1</div>
            <div class="invalid-feedback"><span data-translate="validQuantityError">Por favor ingresa una cantidad válida (mínimo 1)</span></div>
          </div>
          ...
          <div class="form-section">
            ...
            <div class="invalid-feedback" id="fileError" style="display: none;"><span data-translate="addPhotoError">Error al procesar las fotos</span></div>
